    ...
    def __init__(self, application):
        ...
        self.action_roles = {
            'CloudController': {
                ...
                'ImportPublicKey': ['all'],
                'AuthorizeSecurityGroupIngress': ['all'],
                'RevokeSecurityGroupIngress': ['all'],
                'CreateSecurityGroup': ['all'],
                'DeleteSecurityGroup': ['all'],
                'GetConsoleOutput': ['all'],
                'DescribeVolumes': ['all'],
                'CreateVolume': ['all'],
                'AttachVolume': ['all'],
                'DetachVolume': ['all'],
                ...
                'AllocateAddress': ['all'],
                'ReleaseAddress': ['all'],
                'AssociateAddress': ['all'],
                'DisassociateAddress': ['all'],
                'RunInstances': ['all'],
                'TerminateInstances': ['all'],
                'RebootInstances': ['all'],
                'UpdateInstance': ['all'],
                'StartInstances': ['all'],
                'StopInstances': ['all'],
    ...
    def __call__(self, req):
        ...
        try:
            ...
            LOG.info(_('NotAuthorized raised: %s'), unicode(ex),
                    context=context)
            return self._error(req, context, type(ex).__name__, unicode(ex))
        except exception.AssociateAddressFailed as ex:
